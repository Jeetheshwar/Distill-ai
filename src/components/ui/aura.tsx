  ...
  if (variant === "hero") {
    return (
      <div className="absolute inset-0 z-0 pointer-events-none overflow-visible -translate-y-[15vh]">
        {/* Central Intense Blue Glow */}
        <div className="absolute bottom-[-10vh] left-1/2 -translate-x-1/2 w-[70vw] h-[60vh] bg-[radial-gradient(ellipse_at_bottom,_#0052CC_0%,_transparent_60%)] opacity-60 blur-[100px] mix-blend-screen" />
        {/* Solid Bottom Horizon bridging the gap and filling corners */}
        <div className="absolute bottom-0 left-0 right-0 h-[40vh] bg-gradient-to-t from-white via-distill-violet to-transparent opacity-80 blur-[80px] mix-blend-screen" />
        {/* Left Vertical Curve of the U */}
        <div className="absolute bottom-[-10vh] left-[-30vw] w-[90vw] h-[100vh] bg-[radial-gradient(ellipse_at_bottom_left,_white_0%,_var(--distill-violet)_45%,_transparent_70%)] opacity-[0.95] blur-[120px] mix-blend-screen" />
        {/* Right Vertical Curve of the U */}
        <div className="absolute bottom-[-10vh] right-[-30vw] w-[90vw] h-[100vh] bg-[radial-gradient(ellipse_at_bottom_right,_white_0%,_var(--distill-violet)_45%,_transparent_70%)] opacity-[0.95] blur-[120px] mix-blend-screen" />
      </div>
    );
  }
